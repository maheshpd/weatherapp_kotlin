...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchWeatherData(cityName:String) {
        ...
        val response = retrofit.getWeatherData(cityName,"fd8a4c5bc14b0411e4d70fc3d5fed8ed","metric")
    ...
    private fun changeImagesAccordingToWeatherCondtion(condition: String) {
        when (condition) {
